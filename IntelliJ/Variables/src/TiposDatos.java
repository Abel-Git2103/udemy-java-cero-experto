public class TiposDatos {
    public static void main(String[] args) {
        ...
        System.out.println("tipoLong = " + tipoLong); // L o l para indicar que es un tipo long

        // Punto flotante (Su valor por defecto es 0.0)
        float tipoFloat = 3.14F; // F o f para indicar que es un tipo float
        System.out.println("tipoFloat = " + tipoFloat);
        double tipoDouble = 3.1315D; // D o d para indicar que es un tipo double (opcional)
        System.out.println("tipoDouble = " + tipoDouble);

        // Character (Su valor por defecto es '\u0000')
